...
- **Evidence:**
  ...
  - **👁 User-confirmed in the Canva UI:** second CLI-created design `DAHPLSNTDOc` ("Pexabo Visibility Test") opened and edited by the user at https://www.canva.com/design/DAHPLSNTDOc/YHaqbJSFQfr9mC7JPnOwqg/edit — end-to-end CLI → Connect API → visible document proven. (Initial invisibility explained in `6_Semblance/canva_document_visibility.md`.) ✅ 2026-07-12
