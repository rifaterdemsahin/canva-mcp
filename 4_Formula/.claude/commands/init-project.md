...
Sets up a new project from `canva-mcp` by:
...
7. Making the first commit: `chore: initialize project from canva-mcp`
...
```
git add .
git commit -m "chore: initialize <project-name> from canva-mcp"
